...
class Config:
    def __init__(self):
        ...
        self.default['epoch_samples_train'] = 100

        self.parser.add_argument(
            '--epoch_samples_val',
            type=positive_int,
            help='number of validation samples drawn by the RandomSampler per epoch')
        self.default['epoch_samples_val'] = 100
        ...
        self.default['dataset_path_val'] = 'data/hemi/12_micron_cube/val_1500_750_debugged'

        self.parser.add_argument(
            '--dataset_path_test',
            type=str,
            help='the directory to read the test dataset from')
        self.default['dataset_path_test'] = 'data/hemi/17_micron_cube/test_1500_750_debugged'
